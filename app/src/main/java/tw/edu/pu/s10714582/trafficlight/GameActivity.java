...
public class GameActivity extends AppCompatActivity implements DialogInterface.OnCancelListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        GameSV = (tw.edu.pu.s10714582.trafficlight.GameSurfaceView) findViewById(R.id.GameSV);
        //設定初始測試之燈號秒數
        ...
        alertDialog.setTitle("闖紅燈 守規矩");
        alertDialog.setIcon(R.drawable.ic_launcher_background);
        alertDialog.setPositiveButton("太棒拉", new DialogInterface.OnClickListener() {
            @Override
        ...
        alertDialog.setNegativeButton("繼續闖紅燈", new DialogInterface.OnClickListener() {
            @Override
            public void onClick(DialogInterface arg0, int arg1) {
                decorView.setSystemUiVisibility(View.SYSTEM_UI_FLAG_LAYOUT_STABLE
                        | View.SYSTEM_UI_FLAG_LAYOUT_HIDE_NAVIGATION
